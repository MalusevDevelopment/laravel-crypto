...
it('should encrypt/decrypt files', function (string|EncrypterProvider $provider, int $keySize): void {
    ...
    $encryptor = new Encrypter(inMemoryKeyLoader($keySize), new JsonEncoder, null, $providerInstance);
...
it('should throw DecryptException on invalid header for XChaCha20Poly1305', function () {
    $encryptor = new Encrypter(inMemoryKeyLoader(32), new JsonEncoder, null, new XChaCha20Poly1305Encrypter);
...
it('should throw DecryptException on invalid chunk for OpenSSL', function () {
    $encryptor = new Encrypter(inMemoryKeyLoader(32), new JsonEncoder, null, new OpenSSLEncrypter(app(CodeLieutenant\LaravelCrypto\Support\Random::class), 'AES-256-CBC'));
...
it('should throw DecryptException on invalid key for XChaCha20Poly1305', function () {
    ...
    $otherEncryptor = new Encrypter(inMemoryKeyLoader(32), new JsonEncoder, null, new XChaCha20Poly1305Encrypter);
...
it('should throw DecryptException on invalid nonce for other providers', function () {
    $encryptor = new Encrypter(inMemoryKeyLoader(32), new JsonEncoder, null, new AesGcm256Encrypter);
